...
console.log('Loading BackboneCollectionDatabase qUnit configurations.');

define(['text!amd-test-config.json','underscore'], function(testConfigString, undef) {

    console.log('Loading BackboneCollectionDatabase qUnit tests.');
    ...
    return require(tests, function() {
        console.log('Initializing BackboneCollectionDatabase qUnit tests.');
